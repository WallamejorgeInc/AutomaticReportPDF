...
stravhour='\\newcommand{\dataavhour}{'+navhour


replace_line('report.tex',0,strname)
replace_line('report.tex',1,strdate)
replace_line('report.tex',2,strmean)
replace_line('report.tex',3,strvar)
replace_line('report.tex',4,strmax)
replace_line('report.tex',5,strmin)
replace_line('report.tex',6,strsum)
replace_line('report.tex',7,stravhour)
